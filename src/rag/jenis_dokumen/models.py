...
class NamaBerkas(Enum):
    e_klaim = "Klaim Individual Pasien (E-Klaim Kemenkes)"
    ...
    hasil_pemeriksaan_radiologi = "Hasil Pemeriksaan Radiologi"
    ...
    hasil_pemeriksaan_tee = "Hasil Pemeriksaan Tee"
    hasil_pemeriksaan_echocardiography = "Hasil Pemeriksaan Echocardiography"
    hasil_pemeriksaan_setting_ppm = "Hasil Pemeriksaan Setting PPM"
    hasil_pemeriksaan_mata = "Hasil Pemeriksaan Mata RSUD Dr. Soetomo Surabaya"
    hasil_pemeriksaan_bronkoskopi = (
        "Hasil Pemeriksaan Bronkoskopi RSUD Dr. Soetomo Surabaya"
    )
    hasil_pemeriksaan_usg = "Hasil Pemeriksaan USG Obstetri Rutin"
    ...
    lembar_hasil_tindakan_uji_fungsi = "Lembar Hasil Tindakan Uji Fungsi"
