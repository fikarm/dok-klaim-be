...
from src.agents.agent_rule_evaluator.types import JenisRawat


rules: Dict[JenisRawat, List[str]] = {
    JenisRawat.rawat_inap: [
        "Kelas Perawatan pada Berkas Klaim Individual Pasien harus sama nilainya dengan Kls. Rawat pada berkas Surat Eligibilitas Peserta BPJS.",
        ...
        "Pada berkas Ringkasan Pasien Pulang Rawat Inap, jika Keadaan Waktu KRS adalah Atas Persetujuan Dokter, maka Cara Pulang pada berkas Klaim Individual Pasien juga harus Atas Persetujuan Dokter",  # TODO: Atas Persetujuan Dokter?
        ...
        "Pada Berkas Klaim Individual Pasien, setelah kata Prosedur, terdapat beberapa kode ICD-9. Jika dua digit awal kode ICD-9 lebih kecil atau sama 86, maka harus melampirkan berkas Laporan Operasi Rawat Inap",
        "Pada Berkas Klaim Individual Pasien, setelah kata Prosedur, terdapat beberapa kode ICD-9. Jika ada kode ICD-9: 96.71 atau 96.72 atau 93.90 atau 93.960, maka harus ada berkas Surat Keterangan Penggunaan Alat Bantu Pernafasan",
        "Pada Berkas Klaim Individual Pasien, terdapat informasi mengenai biaya Special CMG (Case Main Group). Jika nilainya Rp. 0.00, berarti tidak ada biaya. Selain itu maka ada biaya dan wajib ada berkas resep obat/alkes.",
        "Pada Berkas Klaim Individual Pasien, setelah kata Diagnosa Sekunder, terdapat beberapa kode ICD-10. Jika terdapat kode ICD-10 Z38.0, maka harus ada berkas Surat Keterangan Lahir",
        #
        ...
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Pada Berkas Klaim Individual Pasien, juga ada informasi juga mengenai LOS (Length of Stay). Jika kode ICD-10 itu adalah Z51.1 dan LOS lebih dari 5 hari, maka dokumen tidak valid dan perlu melakukan reseleksi Diagnosa Utama.",
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah D56.1 maka harus ada berkas Protokol PEMBERIAN KELASI BESI",
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah D56.1 maka harus ada berkas E-RESEP",
        #
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah D66 atau D67, maka harus ada berkas Protokol PEMBERIAN KONSENTRAT",
        # "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah D66 atau D67, maka harus ada berkas HASIL PEMERIKSAAN LABORATORIUM PATOLOGI KLINIK (Faal Koagulasi)",
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah D66 atau D67, maka harus ada berkas E-RESEP",
        "Pada Berkas Klaim Individual Pasien, terdapat informasi Diagnosa Utama dalam format ICD-10. Jika kode ICD-10 itu adalah E40, E41, E42, E43, E44, E45, dan E46 maka wajib ada berkas Asesmen Gizi",
