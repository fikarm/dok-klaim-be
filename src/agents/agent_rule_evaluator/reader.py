import os
import src.agents.agent_rule_evaluator.searcher as cari
from fitz import Document
from src.agents.agent_rule_evaluator.extractor import ekstraktor
...
class DokumenKlaim(object):
    ...
    def __init__(self, pdf: Document):
        ...
        self.nosep = cari.nosep(eklaim) or ""
