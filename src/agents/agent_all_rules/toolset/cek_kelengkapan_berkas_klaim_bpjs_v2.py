...
def generate_system_message(pdf):
    ...
    isi_dokumen = {
        ...
        "berkas resep obat/alkes": {},
        "Surat Keterangan Telah Dilakukan Pengambilan Sampel Skrining Hipotiroid Kongenital ": {},
        "Surat Keterangan Lahir (melahirkan di RSDS)": {},
        "Protokol PEMBERIAN KELASI BESI dan E-RESEP": {},
        "Protokol PEMBERIAN KOSENTRAT, HASIL PEMERIKSAAN LABORATORIUM PATOLOGI KLINIK (Faal Koagulasi) dan E-RESEP": {},
        "Asesmen Gizi": {},
        ...
        "LAPORAN HASIL ELEKTROENSEFALOGRAFI ( EEG)": {},
        "HASIL PEMERIKSAAN TEE (EKOKARDIOGRAFI)": {},
        "HASIL PEMERIKSAAN SETTING PPM": {},
        "HASIL ECG SEGMENT": {},
        "MONITORING CARSINOMA TIROID": {},
        "HASIL PEMERIKSAAN RADIOLOGI (Tindakan BMD)": {},
        "HASIL PEMERIKSAAN LABORATORIUM PATOLOGI KLINIK atau BMA": {},
        "KARTU TERAPI REHABILITASI MEDIK": {},
        "CATATAN HARIAN RADIASI EKSTERNA": {},
        "LAPORAN OPERASI (RJ)": {},
    }
