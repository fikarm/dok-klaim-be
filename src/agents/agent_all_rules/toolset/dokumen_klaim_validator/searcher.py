...
from src.agents.agent_all_rules.toolset.dokumen_klaim_validator.types import HalamanDitemukan, JenisRawat
...
def multi_halaman(
    ...
    return HalamanDitemukan(
        range(page_start, page_end + 1), get_texts(pages[page_start : page_end + 1])
    )
